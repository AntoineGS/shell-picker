...
TASK20_PACKAGES='./internal/session ./internal/sessionipc ./internal/candidate ./internal/process ./internal/callback ./internal/fzfsidecar ./internal/preview ./internal/fzf ./internal/app ./internal/pathutil ./integration'
